    ...
    <div class="container">
        <div class="row">
            ...
            <div class="address-footer-wrap col-md-6">
                ...
                Đường Quang Trung, Hà Đông, HÀ Nội <br/>
                Hotline: 0981998984 <br/>
                Email: nguyenbadat1092k@gmail.com
            </div>
            <div class="social-footer-wrap col-md-3">
                <strong>Kết nối với chúng tôi</strong>
                <ul>
                    <li>
                        <a href="https://www.facebook.com/profile.php?id=100014411171023">
        ...
        <p class="footer-copyright">
            Copyright 2020 by BaDat. All rights reserved
        </p>
    </div>
</div>
