    ...
    <div class="container">
        <div class="row">
            <div class=" col-md-4 col-sm-4 col-xs-12">
                <a class="info-contact" href="tel:09819989">
                    <i class="fas fa-phone-alt"></i> 09...
                </a>
                <a class="info-contact" href="mailto:nguyenbadat1092k@gmail.com">
                    <i class="far fa-envelope"></i> nguyenbadat1092k@gmail.com
                </a>
            </div>
...
<header class="header">
    ...
    <div class="header-wrapper container">
        ...
        <div class="header-menu">
            ...
            <ul class="header-navigation" data-show-menu-on-mobile>
                <li>
                    <h2><a href="index.php" class="home-link material-button submenu-toggle">
                        BA ĐẠT
                        </a></h2>
